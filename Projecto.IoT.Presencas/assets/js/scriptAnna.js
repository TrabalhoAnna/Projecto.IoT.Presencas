...
var dispSelecAnteriorT;//Para guardar qual a disciplina guardade anteriormente

function DispSelectT(Select) {

    var disp = document.querySelectorAll('[id=Turmas]');//Vai buscar todos os elementos com o id=Disciplina

    var dispS = document.getElementsByClassName('DispSelect');//Vai buscar todos os elementos com o class=DispSelect

    var DiscpTab = document.getElementById(Select.textContent);//Pega o elemento com o id = ao conteudo do elemento clicado

    var DiscpTabAnterior = document.getElementById(dispSelecAnteriorT);//Pega o elemento com o id = ao conteudo do elemento clicado anteriormente
    

    if (dispS.length === 1) {//Caso nao exista um elemento com o id=DispSelect altera a classe do elemente clicado para DispSelect e mostra um novo card
        Select.className = "DispSelect";
        DiscpTab.style.display = "block";
    }
    else {//Caso já exista
        dispS[1].className = "Disp";//Altera a classe do elemento que contenha como classe=DispSelect
        DiscpTabAnterior.style.display = "none";//Escondendo o card
    ...
    dispSelecAnteriorT = Select.textContent;//Salva o conteudo do elemento selecionado
}
